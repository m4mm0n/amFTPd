...
namespace amFTPd.Core.Site
{
    ...
    public sealed class SiteCommandContext
    {
        ...
        /// </summary>
        /// <remarks>The returned <see cref="IUserStore"/> is managed by the router and may depend on the
        /// router's configuration. Ensure the router is properly initialized before accessing this property.</remarks>
